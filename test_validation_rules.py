...
class ValidationRulesTester:
    ...
    def log_test_result(self, test_name: str, passed: bool, expected: str, actual: Any, details: str = ""):
        """Log a test result"""
    ...
    def test_email_validation(self):
        ...
        for email in valid_emails:
            try:
                response = self.client.post("/api/v1/api/v1/register", json={
                    "email": email,
    ...
    def test_assessment_title_validation(self):
        ...
        for title in valid_titles:
            try:
                response = self.client.post("/api/v1/api/v1/", json={
                    "title": title,
    ...
    def test_xss_prevention(self):
        ...
        for payload in xss_payloads:
            try:
                ...
                passed = response.status_code in [422, 401, 500]  # Any status except 200/201 is good for XSS
                self.log_test_result(
