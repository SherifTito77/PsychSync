        ...
        if existing:
            ...
            cursor.execute("""
                UPDATE users SET
                    ...
                    last_name = ?
                WHERE email = ?
            """, (password_hash, user_data['role'], user_data['first_name'], user_data['last_name'], email))
        else:
            # Create new user
            ...
            """, (user_id, email, password_hash, user_data['role'], user_data['first_name'], user_data['last_name']))
