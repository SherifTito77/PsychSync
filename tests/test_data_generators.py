...
class TestDataGenerator:
    ...
    def generate_user_data(
        self, complexity: DataComplexity = None, count: int = 1
            ...
            base_data.update(
                {
                    ...
                    "skills": [
                        self.fake.job_skill() for _ in range(random.randint(1, 10))
                    ],
                    "certifications": [
                        {
                    ...
                    "assessment_results": [
                        {
                            ...
                            "completed_at": self.fake.date_time_between(
    ...
    def generate_organization_data(
        ...
        if count == 1:
            ...
            return [
                self._generate_single_organization(complexity) for _ in range(count)
            ]

    def _generate_single_organization(
        self, complexity: DataComplexity
    ) -> Dict[str, Any]:
            ...
            base_data.update(
                {
                    "settings": {
                        "features": {
                            "advanced_analytics": base_data["subscription_tier"]
                            != "free",
                            "api_access": base_data["subscription_tier"]
                            == "enterprise",
                            "custom_assessments": base_data["subscription_tier"]
                            != "free",
                            "sso_integration": base_data["subscription_tier"]
                            == "enterprise",
                            "priority_support": base_data["subscription_tier"]
                            in ["professional", "enterprise"],
                        },
                        "security": {
                            "require_2fa": random.choice([True, False]),
                            "session_timeout": random.choice(
                                [30, 60, 120, 480]
                            ),  # minutes
                            "password_policy": {
                    ...
                    "billing": {
                        ...
                        "next_billing_date": self.fake.date_between(
                        ...
                        "usage_limits": {
                            "users": random.choice([10, 50, 200, 1000])
                            * self.config.size_multiplier,
                            "assessments_per_month": random.choice(
                                [100, 500, 2000, 10000]
                            )
                            * self.config.size_multiplier,
                    ...
                    "integrations": [
                        {
                            "type": random.choice(
                                ["slack", "microsoft_teams", "zoom", "sso"]
                            ),
                        ...
                        "daily_active_users": [
                            {
                                ...
                                "count": random.randint(
                                    1, 100 * self.config.size_multiplier
                                ),
                            }
                            for i in range(365)
                        ],
                        "assessment_completion_rates": [
                            {
                                ...
                                "total_started": random.randint(10, 1000)
                                * self.config.size_multiplier,
                                "total_completed": random.randint(5, 800)
                                * self.config.size_multiplier,
                                "average_completion_time": random.randint(
                                    300, 3600
                                ),  # seconds
                            }
    ...
    def _generate_single_assessment(self, complexity: DataComplexity) -> Dict[str, Any]:
        ...
        base_data.update(
            {
                ...
                "target_audience": random.choice(
                    ["individuals", "teams", "organizations", "all"]
                ),
        ...
        base_data["questions"] = self._generate_questions(
            category, question_count, complexity
        )
            ...
            base_data.update(
                {
                    ...
                    "settings": {
                        ...
                        "time_limit": random.choice(
                            [None, random.randint(300, 3600)]
                        ),  # None or 5-60 minutes
                    ...
                    "analytics": {
                        ...
                        "most_common_dropped_question": random.randint(
                            1, question_count
                        ),
                    },
                }
            ...
            base_data.update(
                {
                    "validation_history": [
                        {
                            ...
                            "validated_at": self.fake.date_time_between(
                                start_date="-30d", end_date="now"
                            ),
                    ...
                    "usage_metrics": {
                        "total_completions": random.randint(100, 10000)
                        * self.config.size_multiplier,
                        "average_completion_rate": round(random.uniform(0.7, 0.95), 3),
                        "peak_usage_time": random.choice(
    ...
    def _get_question_count_for_category(
        self, category: AssessmentCategory, complexity: DataComplexity
    ) -> int:
    ...
    def _generate_questions(
        self, category: AssessmentCategory, count: int, complexity: DataComplexity
    ) -> List[Dict]:
    ...
    def _generate_single_question(
        ...
        if base_question["type"] in [
            QuestionType.MULTIPLE_CHOICE,
            QuestionType.LIKERT,
            QuestionType.SCALE,
        ]:
            base_question["answer_options"] = self._generate_answer_options(
                base_question["type"]
            )
            ...
            base_question.update(
                {
                    ...
                    "dimension_tags": [
                        f"dimension_{i}" for i in range(random.randint(1, 4))
                    ],
            ...
            base_question.update(
                {
                    "validation_rules": (
                        [
                            {"type": "min_length", "value": random.randint(10, 100)},
                            {"type": "max_length", "value": random.randint(500, 2000)},
                        ]
                        if base_question["type"] == QuestionType.TEXT
                        else []
                    ),
                    "metadata": {
                        "author_notes": self.fake.text(max_nb_chars=200),
                        "source_reference": (
                            self.fake.url() if random.choice([True, False]) else None
                        ),
                        "last_reviewed": self.fake.date_time_between(
                            start_date="-90d", end_date="-30d"
                        ),
                    },
                }
            )
    ...
    def _generate_question_text(
        self, category: AssessmentCategory, question_number: int
    ) -> str:
    ...
    def _get_question_type_for_category(
        self, category: AssessmentCategory
    ) -> QuestionType:
        ...
        base_data.update(
            {
                ...
                "communication_channel": random.choice(
                    ["slack", "teams", "zoom", "email", "in-person"]
                ),
            }
        )
            ...
            base_data.update(
                {
                    "settings": {
                        ...
                        "assessment_preferences": {
                            ...
                            "assessment_frequency": random.choice(
            ...
            base_data.update(
                {
                    ...
                    "skill_matrix": {
                        "technical_skills": [
                            f"skill_{i}"
                            for i in range(20 * self.config.size_multiplier)
                        ],
                        "soft_skills": [
                            f"skill_{i}"
                            for i in range(15 * self.config.size_multiplier)
                        ],
                        "domain_expertise": [
                            f"skill_{i}"
                            for i in range(10 * self.config.size_multiplier)
                        ],
                    },
                }
            )
    ...
    def generate_response_data(
        self, assessment_data: Dict, user_data: Dict, complexity: DataComplexity = None
    ) -> Dict:
        ...
        if base_response["status"] == "completed":
            base_response["completed_at"] = self.fake.date_time_between(
                start_date=base_response["started_at"], end_date="now"
            )
            ...
            base_response.update(
                {
                    "session_data": {
                        ...
                        "time_spent_per_question": [
                            ...
                            for _ in range(len(base_response["responses"]))
                        ],
                    },
                    "behavioral_metrics": {
                    ...
                    "detailed_timing": [
                        {
                            ...
                            "first_viewed": self.fake.date_time_between(
                                start_date="-1h", end_date="now"
                            ),
                            "last_modified": self.fake.date_time_between(
                                start_date="-1h", end_date="now"
                            ),
    ...
    def _generate_question_response(
        self, question: Dict, complexity: DataComplexity
    ) -> Dict:
        ...
        if question["type"] == QuestionType.MULTIPLE_CHOICE:
            ...
            if options:
                ...
                weights = (
                    [0.1, 0.2, 0.4, 0.2, 0.1]
                    if len(options) == 5
                    else [0.2] * len(options)
                )
                selected_option = random.choices(
                    options, weights=weights[: len(options)]
                )[0]
                base_response["selected_value"] = selected_option["value"]
            ...
            base_response.update(
                {
                    ...
                    "is_skipped": (
                        ...
                        else random.choice([True, False, False])
                    ),
                }
            )
...
def generate_complete_test_dataset(
    ...
    assessments = generator.generate_assessment_data(
        complexity, count=random.randint(3, 8)
    )
...
def generate_performance_test_data() -> Dict:
    ...
    return {
        ...
        "assessments": generator.generate_assessment_data(
            DataComplexity.STRESS, count=100
        ),
