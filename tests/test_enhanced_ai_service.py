...
class TestEnhancedAIProcessor:
    ...
    @pytest.mark.asyncio
    async def test_process_enhanced_assessment_mbti(self, processor, sample_user_context):
        ...
        # Process assessment
        result = processor.process_enhanced_assessment(framework, data, sample_user_context)
    ...
    def test_get_personalized_recommendations_with_context(self, processor):
        ...
        result = processor._get_personalized_recommendations(framework, data, user_context)
    ...
    def test_get_personalized_recommendations_team_member(self, processor):
        ...
        assert isinstance(result, list)
        assert any('working preferences' in rec for rec in result)  # Team member context

    @pytest.mark.parametrize("personality_type,expected_role", [
    ...
    async def test_process_enhanced_assessment_full_pipeline(self, processor):
        ...
        expected_sections = [
            'type', 'framework', 'confidence', 'description',
            'detailed_analysis', 'workplace_compatibility', 'development_areas',
            'strengths', 'growth_opportunities', 'team_dynamics',
            'leadership_potential', 'communication_style', 'decision_making',
            'stress_management', 'personalized_recommendations'
        ]
