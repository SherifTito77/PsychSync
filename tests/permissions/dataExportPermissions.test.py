...
class MockDataExportService:
    ...
    @staticmethod
    def check_export_permission(user_id: str, export_type: str, scope: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    async def create_export_job(user_id: str, export_config: Dict[str, Any]) -> Dict[str, Any]:
...
class TestDataExportPermissions:
    ...
    def test_concurrent_export_permission_checks(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
            ...
            export_types = ['assessments', 'users', 'team_assessments', 'personal_assessments']
