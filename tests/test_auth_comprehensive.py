...
class TestUserRegistration:
    ...
    async def test_register_user_success(self, async_client: AsyncClient, mock_email_service):
    ...
    async def test_register_triggers_verification_email(self, async_client: AsyncClient, mock_email_service):
...
class TestUserAuthentication:
    ...
    async def test_login_unverified_user(self, async_client: AsyncClient, async_session: AsyncSession):
...
class TestTokenManagement:
    ...
    async def test_access_token_validity(self, async_client: AsyncClient, auth_headers: dict):
    ...
    async def test_access_token_expires(self, async_client: AsyncClient, test_user: User):
...
class TestEmailVerification:
    ...
    async def test_verify_email_success(self, async_client: AsyncClient, async_db: AsyncSession):
        ...
        response = await async_client.get(f"/api/v1/auth/verify-email/{verification_token}")
    ...
    async def test_resend_verification_email(self, async_client: AsyncClient, async_db: AsyncSession, mock_email_service):
        ...
        response = await async_client.post("/api/v1/auth/resend-verification", json=email_data)

        assert response.status_code == 200
        mock_email_service.send_verification_email.assert_called()

    async def test_resend_verification_verified_user(self, async_client: AsyncClient, test_user: User):
...
class TestPasswordReset:
    ...
    async def test_request_password_reset(self, async_client: AsyncClient, test_user: User, mock_email_service):
    ...
    async def test_reset_password_success(self, async_client: AsyncClient, test_user: User):
        ...
        login_response = await async_client.post("/api/v1/auth/login/json", json=login_data)
    ...
    async def test_reset_password_expired_token(self, async_client: AsyncClient, test_user: User):
...
class TestRoleBasedAccess:
    ...
    async def test_admin_access_to_admin_endpoint(self, async_client: AsyncClient, admin_headers: dict):
    ...
    async def test_user_denied_admin_endpoint(self, async_client: AsyncClient, auth_headers: dict):
        """Test regular user cannot access admin endpoints"""
        response = await async_client.get("/api/v1/admin/users", headers=auth_headers)

        assert response.status_code in [403, 404]  # Forbidden or Not Found

    async def test_moderator_access(self, async_client: AsyncClient, moderator_headers: dict):
...
class TestAuthenticationPerformance:
    ...
    async def test_login_performance(self, async_client: AsyncClient, test_user: User, performance_timer):
    ...
    async def test_token_validation_performance(self, async_client: AsyncClient, auth_headers: dict, performance_timer):
        """Test token validation performance"""
        with performance_timer():
            response = await async_client.get("/api/v1/users/me", headers=auth_headers)
            assert response.status_code == 200

    async def test_registration_performance(self, async_client: AsyncClient, mock_email_service, performance_timer):
...
class TestAuthenticationIntegration:
    ...
    async def test_complete_user_flow(self, async_client: AsyncClient, mock_email_service):
        ...
        verify_response = await async_client.get(f"/api/v1/auth/verify-email/{verification_token}")
    ...
    async def test_token_refresh_flow(self, async_client: AsyncClient, test_user: User):
        ...
        if refresh_token:
            ...
            if refresh_response.status_code == 200:
                ...
                me_response = await async_client.get("/api/v1/users/me", headers=new_headers)
                assert me_response.status_code == 200
