    ...
    class Tracker:
        ...
        def checkpoint(self, name: str):
            self.checkpoints.append(
                {"name": name, "elapsed": time.time() - self.start_time}
            )
...
pytest.mark.skip_database = pytest.mark.skip(
    reason="Skipping database-dependent test for speed"
)
pytest.mark.skip_redis = pytest.mark.skip(
    reason="Skipping Redis-dependent test for speed"
)
