...
from app.services.security import create_access_token, get_password_hash, verify_token
...
class TestSessionExpirationBehavior:
    ...
    def test_session_creation_with_expiration(self):
        ...
        token = create_access_token(
            data=user_data, expires_delta=datetime.timedelta(minutes=30)
        )
    ...
    def test_session_expiration_detection(self):
        ...
        user_data = {"sub": "test_user_123", "exp": expired_time}
    ...
    def test_session_concurrent_login_handling(self):
        ...
        user_data = {"sub": "test_user_123", "session_id": "session_1"}
    ...
    def test_session_termination_on_password_change(self):
        ...
        user_data = {"sub": "test_user_123", "password_version": 1}
    ...
    def test_session_inactivity_timeout(self):
        ...
        assert (
            time_since_activity > inactivity_threshold
    ...
    def test_session_activity_extension(self):
        ...
        assert recent_activity < datetime.timedelta(
            minutes=1
    ...
    def test_session_encryption_strength(self):
        ...
        user_data = {"sub": "test_user_123", "sensitive_data": "encrypted_value"}
...
class TestSessionManagementIntegration:
    ...
    def test_session_cleanup_expired_tokens(self):
        ...
        tokens = [
            ...
            # Valid token
            create_access_token(
                data={"sub": "valid_user"}, expires_delta=datetime.timedelta(minutes=30)
            ),
        ]
