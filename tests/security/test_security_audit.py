...
class PsychSyncSecurityAuditor:
    ...
    def check_xss_risks(self):
        ...
        jinja_files = list(self.project_root.rglob("*.jinja2")) + list(
            self.project_root.rglob("*.j2")
        )
    ...
    def check_dependency_vulnerabilities(self):
        ...
        try:
            ...
            if vulnerabilities_found == 0:
                ...
                print(
                    f"  ⚠️  Found {vulnerabilities_found} potentially vulnerable dependencies"
                )
    ...
    def check_hardcoded_credentials(self):
        ...
        env_files = list(self.project_root.rglob(".env*")) + list(
            self.project_root.rglob("config*")
        )
    ...
    def check_debug_mode(self):
        ...
        if not debug_enabled:
            ...
            print(
                f"  ⚠️  Debug mode enabled in {len(debug_enabled)} configuration files"
            )
    ...
    def generate_security_report(self):
        ...
        if total_findings > 0:
            ...
            for category in sorted(categories):
                ...
                category_findings = [
                    f for f in self.security_findings if f["category"] == category
                ]
