...
def public_health_check(client):
    """
...
def detailed_health_check(client, auth_headers):
    """
...
def get_metrics(client, auth_headers):
    """
    Test GET /metrics
...
def get_cache_metrics(client, auth_headers):
    """
...
def get_business_metrics_endpoint(client, auth_headers):
    """
    Test GET /metrics/business
