...
def create_export_request(client, auth_headers):
    """
    Test POST /data-exports
...
def list_user_exports(client, auth_headers):
    """
    Test GET /data-exports
...
def get_export_status(client, auth_headers):
    """
    Test GET /data-exports/{export_id}
...
def download_export(client, auth_headers):
    """
    Test GET /data-exports/{export_id}/download
...
def delete_export(client, auth_headers):
    """
    Test DELETE /data-exports/{export_id}
...
def get_export_statistics(client, auth_headers):
    """
    Test GET /data-exports/statistics
...
def cleanup_expired_exports(client, auth_headers):
    """
    Test POST /data-exports/cleanup
...
def get_available_formats(client, auth_headers):
    """
    Test GET /data-exports/formats
...
def get_available_scopes(client, auth_headers):
    """
    Test GET /data-exports/scopes
