...
def get_personality_frameworks(client):
    """
    Test GET /frameworks
...
def get_user_personality_assessments(client, auth_headers):
    """
    Test GET /user-assessments/{user_id}
...
def create_personality_assessment(client, auth_headers):
    """
    Test POST /take-assessment
...
def submit_personality_assessment(client, auth_headers):
    """
    Test POST /submit-response/{assessment_id}
...
def compare_personality_results(client, auth_headers):
    """
    Test GET /compare-results/{user_id}
...
def get_team_personality_profile(client, auth_headers):
    """
    Test GET /team-personality-profile/{team_id}
...
def process_personality_assessment(client, auth_headers):
    """
    Test POST /process
