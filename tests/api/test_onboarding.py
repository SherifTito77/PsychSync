...
def quick_assessment(client, auth_headers):
    """
    Test POST /quick-assessment
...
def get_team_insights(client, auth_headers):
    """
...
def get_onboarding_status(client, auth_headers):
    """
...
def setup_wizard_step(client, auth_headers):
    """
    Test POST /setup-wizard
...
def get_value_metrics(client, auth_headers):
    """
