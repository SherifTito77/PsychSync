...
def aggregate_time_series_data(client, auth_headers):
    """
    Test POST /aggregate-time-series
...
def detect_behavioral_changes(client, auth_headers):
    """
    Test POST /detect-changes
...
def analyze_trends(client, auth_headers):
    """
    Test POST /analyze-trends
...
def calculate_baseline(client, auth_headers):
    """
    Test POST /calculate-baseline
...
def analyze_user_progression(client, auth_headers):
    """
    Test POST /analyze-user-progression
...
def compare_longitudinal_data(client):
    """
    Test POST /compare-users
