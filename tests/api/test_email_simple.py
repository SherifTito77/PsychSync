...
def get_email_providers(client):
    """
    Test GET /providers
...
def get_setup_guide(client):
    """
    Test GET /setup-guide/{provider}
...
def quick_test_connection(client):
    """
    Test POST /quick-test
...
def connect_email_simple(client, auth_headers):
    """
    Test POST /connect
...
def get_my_connections(client, auth_headers):
    """
...
def sync_emails_simple(client, auth_headers):
    """
...
def delete_connection_simple(client, auth_headers):
    """
...
def get_connection_status(client, auth_headers):
    """
    Test GET /connection-status/{connection_id}
...
def get_troubleshooting_help(client):
    """
    Test GET /help/troubleshooting
