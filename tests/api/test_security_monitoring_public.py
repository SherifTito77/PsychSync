...
def get_security_metrics(client, auth_headers):
    """
...
def get_security_timeline(client, auth_headers):
    """
    Test GET /dashboard/stats/timeline
...
def send_test_alert(client, auth_headers):
    """
    Test POST /dashboard/test-alert
