...
from app.services.recommendation import RecommendationEngine, TeamMember, TeamComposition
...
class TestRecommendationEngine:
    ...
    def setup_method(self):
        ...
        self.sample_members = [
            ...
            },
            {
                ...
                'skills': ['Agile', 'Scrum', 'Roadmapping', 'Analytics', 'Communication'],
                'experience_years': 6
            },
            {
                'id': 4,
    ...
    def test_personality_compatibility_calculation(self):
        ...
        incompatible_traits_b = {
            'openness': 0.9, 'conscientiousness': 0.8, 'extraversion': 0.1,
    ...
    def test_role_compatibility_matrix(self):
        ...
        developer_designer_compat = self.engine._get_role_compatibility('developer', 'developer')
        developer_designer_compat = self.engine._get_role_compatibility('developer', 'designer')
    ...
    def test_team_strengths_identification(self):
        ...
        well_rounded_team = [
            TeamMember(1, 'Alice', 'senior_developer', {}, ['Python', 'React'], experience_years=8),
            TeamMember(2, 'Bob', 'designer', {}, ['Figma', 'UX'], experience_years=5),
            TeamMember(3, 'Carol', 'qa', {}, ['Testing', 'Automation'], experience_years=4),
            TeamMember(4, 'David', 'pm', {}, ['Agile', 'Communication'], experience_years=6)
        ]
    ...
    def test_team_risks_identification(self):
        ...
        risky_team = [
            TeamMember(1, 'Alice', 'junior_developer', {}, ['Python'], experience_years=1),
            TeamMember(2, 'Bob', 'junior_developer', {}, ['Python'], experience_years=1),
            TeamMember(3, 'Carol', 'junior_developer', {}, ['Python'], experience_years=1)
        ]

        risks = self.engine._identify_team_risks(risky_team)

        assert len(risks) > 0
        assert any('junior' in risk.lower() or 'experience' in risk.lower() for risk in risks)
...
class TestPersonalityMapping:
    ...
    def test_predictive_index_conversion(self):
        ...
        pi_traits = {'A': 80, 'B': 30, 'C': 70, 'D': 60}  # High dominance, low extraversion
    ...
    def test_clifton_strengths_conversion(self):
        ...
        strengths_traits = {'strengths': ['Achiever', 'Learner', 'Ideation', 'Analytical']}
    ...
    def test_compatibility_insights(self):
        ...
        traits_b = {
            'openness': 0.2, 'conscientiousness': 0.3, 'extraversion': 0.4,
            'agreeableness': 0.3, 'neuroticism': 0.8
        }
...
class TestTeamOptimizationAPI:
    ...
    async def test_concurrent_requests(self):
        ...
        assert all(isinstance(result, int) or isinstance(result, Exception) for result in results)
