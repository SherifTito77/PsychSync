...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "privacy_level",
            sa.Enum("METADATA_ONLY", "ANONYMIZED", "FULL", name="privacylevel"),
            nullable=False,
            server_default="metadata_only",
        ),
        sa.Column(
            "sync_frequency_hours", sa.Integer(), nullable=False, server_default="24"
        ),
        sa.Column(
            "data_retention_days", sa.Integer(), nullable=False, server_default="90"
        ),
        sa.Column(
            "requires_consent", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "granted_at", sa.DateTime(), nullable=False, server_default=sa.text("now()")
        ),
    ...
    op.create_index(
        op.f("ix_integration_consents_id"), "integration_consents", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "time_window_days", sa.Integer(), nullable=False, server_default="30"
        ),
    ...
    op.create_index(
        op.f("ix_behavioral_profiles_id"), "behavioral_profiles", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_behavioral_profiles_profile_date"),
        "behavioral_profiles",
        ["profile_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_behavioral_profiles_user_id"),
        "behavioral_profiles",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_behavioral_insights_category"),
        "behavioral_insights",
        ["category"],
        unique=False,
    )
    op.create_index(
        op.f("ix_behavioral_insights_detected_at"),
        "behavioral_insights",
        ["detected_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_behavioral_insights_id"), "behavioral_insights", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_behavioral_insights_severity"),
        "behavioral_insights",
        ["severity"],
        unique=False,
    )
    op.create_index(
        op.f("ix_behavioral_insights_user_id"),
        "behavioral_insights",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_integration_sync_logs_id"),
        "integration_sync_logs",
        ["id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "is_after_hours", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_index(
        op.f("ix_email_metadata_day_of_week"),
        "email_metadata",
        ["day_of_week"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_metadata_hour_of_day"),
        "email_metadata",
        ["hour_of_day"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_metadata_id"), "email_metadata", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_email_metadata_is_after_hours"),
        "email_metadata",
        ["is_after_hours"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_metadata_is_weekend"),
        "email_metadata",
        ["is_weekend"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_metadata_message_id"),
        "email_metadata",
        ["message_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_email_metadata_sent_at"), "email_metadata", ["sent_at"], unique=False
    )
    op.create_index(
        op.f("ix_email_metadata_thread_id"),
        "email_metadata",
        ["thread_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_email_metadata_user_id"), "email_metadata", ["user_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("is_weekend", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column(
            "is_back_to_back", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "gap_minutes_before", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "gap_minutes_after", sa.Integer(), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        op.f("ix_calendar_events_event_id"),
        "calendar_events",
        ["event_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_calendar_events_is_after_hours"),
        "calendar_events",
        ["is_after_hours"],
        unique=False,
    )
    op.create_index(
        op.f("ix_calendar_events_is_weekend"),
        "calendar_events",
        ["is_weekend"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_slack_messages_channel_id"),
        "slack_messages",
        ["channel_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_slack_messages_id"), "slack_messages", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_slack_messages_is_after_hours"),
        "slack_messages",
        ["is_after_hours"],
        unique=False,
    )
    op.create_index(
        op.f("ix_slack_messages_is_weekend"),
        "slack_messages",
        ["is_weekend"],
        unique=False,
    )
    op.create_index(
        op.f("ix_slack_messages_message_id"),
        "slack_messages",
        ["message_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_slack_messages_timestamp"),
        "slack_messages",
        ["timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("ix_slack_messages_user_id"), "slack_messages", ["user_id"], unique=False
    )
