...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "model_parameters", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        ...
        sa.Column(
            "acceleration_rate", sa.Numeric(precision=10, scale=8), nullable=True
        ),
        sa.Column(
            "asymptotic_potential", sa.Numeric(precision=10, scale=4), nullable=True
        ),
        sa.Column("growth_stage", sa.String(length=30), nullable=True),
        sa.Column(
            "plateau_probability", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        sa.Column("inflection_point_date", sa.DateTime(timezone=True), nullable=True),
        sa.Column(
            "development_recommendations", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column(
            "optimal_intervention_timing", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "created_at",
        ...
        sa.CheckConstraint(
            "prediction_horizon_days > 0", name="check_positive_horizon"
        ),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint(
            "trajectory_type IN ('individual', 'team', 'role_based', 'competency_based')",
            name="check_trajectory_type",
        ),
        sa.CheckConstraint(
            "model_type IN ('linear', 'exponential', 'logistic', 'power_law', 'polynomial', 'sigmoidal')",
            name="check_model_type",
        ),
    )
    op.create_index(
        op.f("ix_growth_trajectories_id"), "growth_trajectories", ["id"], unique=False
    )
    op.create_index(
        "ix_growth_trajectories_user", "growth_trajectories", ["user_id"], unique=False
    )
    op.create_index(
        "ix_growth_trajectories_domain",
        "growth_trajectories",
        ["competency_domain"],
        unique=False,
    )
    op.create_index(
        "ix_growth_trajectories_type",
        "growth_trajectories",
        ["trajectory_type"],
        unique=False,
    )
    op.create_index(
        "ix_growth_trajectories_model",
        "growth_trajectories",
        ["model_type"],
        unique=False,
    )
    op.create_index(
        "ix_growth_trajectories_dates",
        "growth_trajectories",
    ...
    op.create_table(
        ...
        sa.Column(
            "milestone_achieved", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "risk_assessment", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "external_factors", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "development_opportunities", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column("potential_barriers", postgresql.ARRAY(sa.String()), nullable=True),
        sa.Column(
            "intervention_suggestions", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column(
            "prediction_metadata",
        ...
        sa.ForeignKeyConstraint(
            ["trajectory_id"], ["growth_trajectories.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_trajectory_predictions_id"),
        "trajectory_predictions",
        ["id"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_predictions_trajectory",
        "trajectory_predictions",
        ["trajectory_id"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_predictions_date",
        "trajectory_predictions",
        ["prediction_date"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_predictions_milestone",
        "trajectory_predictions",
        ["milestone_achieved"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "achievement_probability", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint(
            "achievement_probability >= 0 AND achievement_probability <= 1",
            name="check_achievement_probability",
        ),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint(
            "milestone_type IN ('skill', 'competency', 'role', 'project', 'certification', 'performance')",
            name="check_milestone_type",
        ),
        sa.CheckConstraint(
            "milestone_status IN ('pending', 'in_progress', 'achieved', 'delayed', 'cancelled')",
            name="check_milestone_status",
        ),
        sa.CheckConstraint(
            "priority IN ('low', 'medium', 'high', 'critical')",
            name="check_milestone_priority",
        ),
        sa.CheckConstraint(
    ...
    op.create_index(
        op.f("ix_growth_milestones_id"), "growth_milestones", ["id"], unique=False
    )
    op.create_index(
        "ix_growth_milestones_trajectory",
        "growth_milestones",
        ["trajectory_id"],
        unique=False,
    )
    op.create_index(
        "ix_growth_milestones_status",
        "growth_milestones",
        ["milestone_status"],
        unique=False,
    )
    op.create_index(
        "ix_growth_milestones_priority", "growth_milestones", ["priority"], unique=False
    )
    op.create_index(
        "ix_growth_milestones_date", "growth_milestones", ["target_date"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "adaptability_score", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "development_focus_areas", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column(
            "optimal_development_path", postgresql.ARRAY(sa.String()), nullable=None
        ),
        sa.Column(
        ...
        sa.Column(
            "success_probability", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "confidence_factors", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
        ...
        sa.CheckConstraint(
            ...
            name="check_potential_score_range",
        ),
        sa.CheckConstraint(
            "potential_category IN ('low', 'medium', 'high', 'very_high', 'exceptional')",
            name="check_potential_category",
        ),
        sa.CheckConstraint(
            "growth_readiness >= 0 AND growth_readiness <= 1",
            name="check_growth_readiness_range",
        ),
        sa.CheckConstraint(
            "learning_agility >= 0 AND learning_agility <= 1",
            name="check_learning_agility_range",
        ),
        sa.CheckConstraint(
            "adaptability_score >= 0 AND adaptability_score <= 1",
            name="check_adaptability_score_range",
        ),
    )
    op.create_index(
        op.f("ix_growth_potential_analysis_id"),
        "growth_potential_analysis",
        ["id"],
        unique=False,
    )
    op.create_index(
        "ix_growth_potential_analysis_user",
        "growth_potential_analysis",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        "ix_growth_potential_analysis_date",
        "growth_potential_analysis",
        ["analysis_date"],
        unique=False,
    )
    op.create_index(
        "ix_growth_potential_analysis_category",
        "growth_potential_analysis",
        ["potential_category"],
        unique=False,
    )
    op.create_index(
        "ix_growth_potential_analysis_score",
        "growth_potential_analysis",
        ["potential_score"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "median_trajectory", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "percentile_25_trajectory",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
        ),
        sa.Column(
            "percentile_75_trajectory",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
        ),
        sa.Column(
            "growth_velocity_stats",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
        ),
        sa.Column(
            "time_to_mastery_stats",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
        ),
        sa.Column(
            "plateau_probability_stats",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=True,
        ),
        ...
        sa.Column(
            "benchmark_metadata", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint(
            "experience_level IN ('entry', 'junior', 'mid', 'senior', 'lead', 'principal')",
            name="check_experience_level",
        ),
    )
    op.create_index(
        op.f("ix_trajectory_benchmarks_id"),
        "trajectory_benchmarks",
        ["id"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_benchmarks_domain",
        "trajectory_benchmarks",
        ["competency_domain"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_benchmarks_role",
        "trajectory_benchmarks",
        ["role_category"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_benchmarks_experience",
        "trajectory_benchmarks",
        ["experience_level"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_benchmarks_unique",
        "trajectory_benchmarks",
        ["competency_domain", "role_category", "experience_level"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "outcome_probability", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        sa.Column(
            "success_probability", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "confidence_in_simulation", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        sa.Column(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint(
            "simulation_type IN ('intervention', 'career_change', 'skill_development', 'role_transition', 'leadership', 'environmental')",
            name="check_simulation_type",
        ),
        sa.CheckConstraint(
            "confidence_in_simulation >= 0 AND confidence_in_simulation <= 1",
            name="check_simulation_confidence",
        ),
    )
    op.create_index(
        op.f("ix_trajectory_simulations_id"),
        "trajectory_simulations",
        ["id"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_simulations_trajectory",
        "trajectory_simulations",
        ["trajectory_id"],
        unique=False,
    )
    op.create_index(
        "ix_trajectory_simulations_type",
        "trajectory_simulations",
        ["simulation_type"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # Drop triggers
    op.execute(
        "DROP TRIGGER IF EXISTS update_growth_trajectories_updated_at ON growth_trajectories"
    )
    op.execute(
    ...
    op.drop_index(
        "ix_trajectory_simulations_trajectory", table_name="trajectory_simulations"
    )
    op.drop_index(
        op.f("ix_trajectory_simulations_id"), table_name="trajectory_simulations"
    )
    op.drop_table("trajectory_simulations")

    op.drop_index("ix_trajectory_benchmarks_unique", table_name="trajectory_benchmarks")
    op.drop_index(
        "ix_trajectory_benchmarks_experience", table_name="trajectory_benchmarks"
    )
    ...
    op.drop_index(
        op.f("ix_trajectory_benchmarks_id"), table_name="trajectory_benchmarks"
    )
    op.drop_table("trajectory_benchmarks")

    op.drop_index(
        "ix_growth_potential_analysis_score", table_name="growth_potential_analysis"
    )
    op.drop_index(
        "ix_growth_potential_analysis_category", table_name="growth_potential_analysis"
    )
    op.drop_index(
        "ix_growth_potential_analysis_date", table_name="growth_potential_analysis"
    )
    op.drop_index(
        "ix_growth_potential_analysis_user", table_name="growth_potential_analysis"
    )
    op.drop_index(
        op.f("ix_growth_potential_analysis_id"), table_name="growth_potential_analysis"
    )
    ...
    op.drop_index(
        "ix_trajectory_predictions_milestone", table_name="trajectory_predictions"
    )
    op.drop_index("ix_trajectory_predictions_date", table_name="trajectory_predictions")
    op.drop_index(
        "ix_trajectory_predictions_trajectory", table_name="trajectory_predictions"
    )
    op.drop_index(
        op.f("ix_trajectory_predictions_id"), table_name="trajectory_predictions"
    )
