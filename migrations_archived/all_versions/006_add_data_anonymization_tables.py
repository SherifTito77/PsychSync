...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "privacy_risk_score", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        sa.Column(
            "data_utility_score", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "t_closeness_threshold", sa.Numeric(precision=5, scale=4), nullable=True
        ),
        sa.Column(
            "is_compliant_with_standards", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column(
        ...
        sa.CheckConstraint(
            ...
            name="check_privacy_risk_range",
        ),
        sa.CheckConstraint(
            "data_utility_score >= 0 AND data_utility_score <= 1",
            name="check_data_utility_range",
        ),
        sa.CheckConstraint("k_anonymity_level > 0", name="check_k_anonymity_positive"),
        sa.CheckConstraint(
            "algorithm_type IN ('generalization', 'suppression', 'perturbation', 'synthetic_data', 'differential_privacy', 'k_anonymity', 'l_diversity', 't_closeness')",
            name="check_algorithm_type",
        ),
    )
    op.create_index(
        op.f("ix_anonymization_algorithms_id"),
        "anonymization_algorithms",
        ["id"],
        unique=False,
    )
    op.create_index(
        "ix_anonymization_algorithms_name",
        "anonymization_algorithms",
        ["algorithm_name"],
        unique=False,
    )
    op.create_index(
        "ix_anonymization_algorithms_type",
        "anonymization_algorithms",
        ["algorithm_type"],
        unique=False,
    )
    op.create_index(
        "ix_anonymization_algorithms_active",
        "anonymization_algorithms",
        ["is_active"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "filter_criteria", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "progress_percentage", sa.Numeric(precision=5, scale=2), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "compliance certifications", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
        ...
        sa.ForeignKeyConstraint(
            ["anonymization_algorithm_id"],
            ["anonymization_algorithms.id"],
        ),
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
        ...
        sa.CheckConstraint(
            "export_format IN ('csv', 'json', 'parquet', 'excel', 'spss', 'sas', 'stata')",
            name="check_export_format",
        ),
    )
    op.create_index(
        op.f("ix_data_anonymization_jobs_id"),
        "data_anonymization_jobs",
        ["id"],
        unique=False,
    )
    op.create_index(
        "ix_data_anonymization_jobs_requester",
        "data_anonymization_jobs",
        ["requester_id"],
        unique=False,
    )
    op.create_index(
        "ix_data_anonymization_jobs_organization",
        "data_anonymization_jobs",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        "ix_data_anonymization_jobs_status",
        "data_anonymization_jobs",
        ["status"],
        unique=False,
    )
    op.create_index(
        "ix_data_anonymization_jobs_created",
        "data_anonymization_jobs",
        ["created_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["job_id"], ["data_anonymization_jobs.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint(
            "action_type IN ('created', 'started', 'completed', 'failed', 'cancelled', 'paused', 'resumed', 'data_accessed', 'data_modified', 'export_downloaded')",
            name="check_action_type",
        ),
        sa.CheckConstraint(
            "reversibility_assessment IN ('reversible', 'partially_reversible', 'irreversible', 'unknown')",
            name="check_reversibility",
        ),
    )
    op.create_index(
        op.f("ix_anonymization_audit_logs_id"),
        "anonymization_audit_logs",
        ["id"],
        unique=False,
    )
    op.create_index(
        "ix_anonymization_audit_logs_job",
        "anonymization_audit_logs",
        ["job_id"],
        unique=False,
    )
    op.create_index(
        "ix_anonymization_audit_logs_user",
        "anonymization_audit_logs",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        "ix_anonymization_audit_logs_timestamp",
        "anonymization_audit_logs",
        ["action_timestamp"],
        unique=False,
    )
    op.create_index(
        "ix_anonymization_audit_logs_action",
        "anonymization_audit_logs",
        ["action_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "inclusion_criteria", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "exclusion_criteria", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "data_dictionary", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("anonymization_level", sa.String(length=30), nullable=False),
        sa.Column("privacy_guarantee", sa.Text(), nullable=True),
        sa.Column(
            "usage_restrictions", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.CheckConstraint(
            "embargo_period_days >= 0", name="check_embargo_non_negative"
        ),
        sa.CheckConstraint(
            "export_type IN ('longitudinal', 'cross_sectional', 'case_control', 'cohort', 'experimental', 'observational')",
            name="check_export_type",
        ),
        sa.CheckConstraint(
            "anonymization_level IN ('minimal', 'standard', 'enhanced', 'maximum')",
            name="check_anonymization_level",
        ),
        sa.CheckConstraint(
            "access_method IN ('direct_download', 'secure_transfer', 'api_access', 'research_portal')",
        ...
        sa.CheckConstraint(
            "approval_status IN ('pending', 'approved', 'rejected', 'requires_review')",
    ...
    op.create_index(
        "ix_research_data_exports_researcher",
        "research_data_exports",
        ["researcher_id"],
        unique=False,
    )
    op.create_index(
        "ix_research_data_exports_project",
        "research_data_exports",
        ["research_project_id"],
        unique=False,
    )
    op.create_index(
        "ix_research_data_exports_status",
        "research_data_exports",
        ["status"],
        unique=False,
    )
    op.create_index(
        "ix_research_data_exports_approval",
        "research_data_exports",
        ["approval_status"],
        unique=False,
    )
    op.create_index(
        "ix_research_data_exports_created",
        "research_data_exports",
        ["created_at"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "regulatory_requirements", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column(
            "auto_delete_enabled", sa.Boolean(), nullable=False, server_default="false"
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint(
            "retention_period_days > 0", name="check_retention_positive"
        ),
        sa.CheckConstraint(
            "notification_period_days >= 0", name="check_notification_non_negative"
        ),
        sa.CheckConstraint(
            "anonymization_method IN ('generalization', 'suppression', 'perturbation', 'aggregation', 'pseudonymization')",
            name="check_retention_anonymization_method",
        ),
    )
    op.create_index(
        op.f("ix_data_retention_policies_id"),
        "data_retention_policies",
        ["id"],
        unique=False,
    )
    op.create_index(
        "ix_data_retention_policies_organization",
        "data_retention_policies",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        "ix_data_retention_policies_active",
        "data_retention_policies",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        "ix_data_retention_policies_next",
        "data_retention_policies",
        ["next_scheduled"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "requested_data_tables", postgresql.ARRAY(sa.String()), nullable=False
        ),
        ...
        sa.Column(
            "data_use_agreement", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "collaborating_institutions", postgresql.ARRAY(sa.String()), nullable=True
        ),
        sa.Column(
            "funding_sources", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column("rejection_reason", sa.Text(), nullable=True),
        sa.Column(
            "data_access_granted", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("access_expiry_date", sa.DateTime(timezone=True), nullable=True),
        sa.Column(
            "data_usage_reporting_required",
            sa.Boolean(),
            nullable=False,
            server_default="true",
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint(
            "sample_size_requested > 0", name="check_requested_sample_positive"
        ),
        sa.CheckConstraint(
            "request_type IN ('research', 'commercial', 'educational', 'government', 'non_profit')",
            name="check_request_type",
        ),
        sa.CheckConstraint(
            "anonymization_level_required IN ('minimal', 'standard', 'enhanced', 'maximum')",
            name="check_required_anonymization",
        ),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint(
            "priority IN ('low', 'medium', 'high', 'critical')",
            name="check_access_priority",
        ),
        sa.CheckConstraint(
            "reporting_frequency IN ('weekly', 'monthly', 'quarterly', 'annually', 'upon_completion')",
            name="check_reporting_frequency",
        ),
    )
    op.create_index(
        op.f("ix_data_access_requests_id"), "data_access_requests", ["id"], unique=False
    )
    op.create_index(
        "ix_data_access_requests_request_id",
        "data_access_requests",
        ["request_id"],
        unique=True,
    )
    op.create_index(
        "ix_data_access_requests_researcher",
        "data_access_requests",
        ["researcher_id"],
        unique=False,
    )
    op.create_index(
        "ix_data_access_requests_status",
        "data_access_requests",
        ["status"],
        unique=False,
    )
    op.create_index(
        "ix_data_access_requests_created",
        "data_access_requests",
        ["created_at"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.execute(
        "DROP TRIGGER IF EXISTS update_research_data_exports_updated_at ON research_data_exports"
    )
    op.execute(
        "DROP TRIGGER IF EXISTS update_data_anonymization_jobs_updated_at ON data_anonymization_jobs"
    )
    op.execute(
        "DROP TRIGGER IF EXISTS update_anonymization_algorithms_updated_at ON anonymization_algorithms"
    )
    ...
    op.drop_index(
        "ix_data_access_requests_researcher", table_name="data_access_requests"
    )
    op.drop_index(
        "ix_data_access_requests_request_id", table_name="data_access_requests"
    )
    op.drop_index(op.f("ix_data_access_requests_id"), table_name="data_access_requests")
    op.drop_table("data_access_requests")

    op.drop_index(
        "ix_data_retention_policies_next", table_name="data_retention_policies"
    )
    op.drop_index(
        "ix_data_retention_policies_active", table_name="data_retention_policies"
    )
    op.drop_index(
        "ix_data_retention_policies_organization", table_name="data_retention_policies"
    )
    op.drop_index(
    ...
    op.drop_index(
        "ix_research_data_exports_created", table_name="research_data_exports"
    )
    op.drop_index(
        "ix_research_data_exports_approval", table_name="research_data_exports"
    )
    op.drop_index("ix_research_data_exports_status", table_name="research_data_exports")
    op.drop_index(
        "ix_research_data_exports_project", table_name="research_data_exports"
    )
    op.drop_index(
        "ix_research_data_exports_researcher", table_name="research_data_exports"
    )
    op.drop_index(
    ...
    op.drop_index(
        "ix_anonymization_audit_logs_action", table_name="anonymization_audit_logs"
    )
    op.drop_index(
        "ix_anonymization_audit_logs_timestamp", table_name="anonymization_audit_logs"
    )
    op.drop_index(
        "ix_anonymization_audit_logs_user", table_name="anonymization_audit_logs"
    )
    op.drop_index(
        "ix_anonymization_audit_logs_job", table_name="anonymization_audit_logs"
    )
    op.drop_index(
        op.f("ix_anonymization_audit_logs_id"), table_name="anonymization_audit_logs"
    )
    op.drop_table("anonymization_audit_logs")

    op.drop_index(
        "ix_data_anonymization_jobs_created", table_name="data_anonymization_jobs"
    )
    op.drop_index(
        "ix_data_anonymization_jobs_status", table_name="data_anonymization_jobs"
    )
    op.drop_index(
        "ix_data_anonymization_jobs_organization", table_name="data_anonymization_jobs"
    )
    op.drop_index(
        "ix_data_anonymization_jobs_requester", table_name="data_anonymization_jobs"
    )
    op.drop_index(
        op.f("ix_data_anonymization_jobs_id"), table_name="data_anonymization_jobs"
    )
    op.drop_table("data_anonymization_jobs")

    op.drop_index(
        "ix_anonymization_algorithms_active", table_name="anonymization_algorithms"
    )
    op.drop_index(
        "ix_anonymization_algorithms_type", table_name="anonymization_algorithms"
    )
    op.drop_index(
        "ix_anonymization_algorithms_name", table_name="anonymization_algorithms"
    )
    op.drop_index(
        op.f("ix_anonymization_algorithms_id"), table_name="anonymization_algorithms"
    )
