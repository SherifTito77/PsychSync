...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "survey_type",
            sa.Enum("csat", "nps", "ces", name="surveytype"),
            nullable=False,
        ),
        sa.Column(
            "touchpoint_type",
        ...
        sa.Column(
            "nps_category",
            sa.Enum("promoter", "passive", "detractor", name="npscategory"),
            nullable=True,
        ),
    ...
    op.create_index(
        "idx_satisfaction_survey_type_date",
        "satisfaction_surveys",
        ["survey_type", "responded_at"],
    )
    op.create_index(
        "idx_satisfaction_org_date",
        "satisfaction_surveys",
        ["organization_id", "responded_at"],
    )
    ...
    op.create_index(
        "idx_satisfaction_agg_period",
        "satisfaction_aggregations",
        ["period_type", "period_start"],
    )
    op.create_index(
        "idx_satisfaction_agg_org",
        "satisfaction_aggregations",
        ["organization_id", "period_type"],
    )
    ...
    op.create_index(
        "idx_lifecycle_user_stage",
        "customer_lifecycle_stages",
        ["user_id", "current_stage"],
    )
    op.create_index(
        "idx_lifecycle_org_stage",
        "customer_lifecycle_stages",
        ["organization_id", "current_stage"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "survey_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("satisfaction_surveys.id"),
            nullable=False,
            index=True,
        ),
        sa.Column(
        ...
        sa.Column(
            "follow_up_status", sa.String(length=50), nullable=False, default="pending"
        ),
    ...
    op.create_index(
        "idx_follow_up_alert",
        "satisfaction_follow_ups",
        ["alert_level", "follow_up_status"],
    )
    op.create_index(
        "idx_follow_up_due", "satisfaction_follow_ups", ["due_at", "follow_up_status"]
    )
