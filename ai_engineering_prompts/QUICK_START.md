...
```bash
alias ai-prompts='cd /path/to/psychsync/ai_engineering_prompts && python prompt_engineer.py'
alias ai-web='cd /path/to/psychsync/ai_engineering_prompts && python web_interface.py'
```
...
pwd  # Should show .../psychsync/ai_engineering_prompts
...
0 0 * * 0 cd /path/to/ai_engineering_prompts && ./weekly_audit.sh
```
