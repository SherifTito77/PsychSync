...
class MockBrowser:
    ...
    def click(self, selector: str):
        ...
        self.network_requests.append(
            {"type": "click", "selector": selector, "timestamp": time.time()}
        )
...
class MockUser:
    ...
    def __init__(self, email: str, password: str):
        ...
        self.settings = {
            ...
            "billing": {"plan": "free", "billingEmail": email},
        }
...
class TestProfileSettingsE2E(unittest.TestCase):
    ...
    def test_avatar_upload_workflow(self, mock_post):
        ...
        upload_response = mock_post(
            f"{self.api_base}/settings/avatar", files=upload_data
        )
    ...
    def test_page_load_performance(self):
        ...
        self.assertLess(
            load_time, 3.0, f"Page load took {load_time:.2f}s, should be under 3s"
        )
    ...
    def test_form_submission_performance(self):
        ...
        self.assertLess(
            save_time, 2.0, f"Save took {save_time:.2f}s, should be under 2s"
        )
    ...
    def test_keyboard_navigation_workflow(self):
        ...
        for element in interactive_elements:
            ...
            self.assertIsNotNone(
                focused_element, f"Element {element} should be keyboard accessible"
            )
    ...
    def test_mobile_responsive_workflow(self):
        ...
        for element in mobile_elements:
            ...
            self.assertIsNotNone(
                mobile_element, f"Mobile element should exist: {element}"
            )
    ...
    def test_data_integrity_workflow(self):
        ...
        self.assertEqual(
            name_field.value, original_name, "Data should persist during navigation"
        )
        ...
        name_field = self.browser.find_element('input[name="name"]')
        self.assertEqual(
            name_field.value, modified_name, "Saved data should persist after refresh"
        )
