    ...
    def encrypt_file_gpg(self, file_path: Path, remove_original: bool = False):
        ...
        try:
            ...
            cmd = [
                ...
                "SHA512",
                "--s2k-count",
                "65011712",  # Maximum iteration count
            ...
            if result.returncode == 0 and encrypted_path.exists():
                ...
                print(
                    f"   ✅ Encrypted successfully: {encrypted_path.name} ({file_size_kb} KB)"
                )
            ...
            for file_path in self.base_path.rglob(pattern):
                ...
                try:
                    ...
                    if (
                        ...
                        print(
                            f"📄 Found: {file_path.relative_to(self.base_path)} ({round(file_path.stat().st_size/1024, 2)} KB)"
                        )
