...
def generate_mbti_questions_90():
    ...
    e_i_questions = [
        ...
        (
            "When giving presentations, do you:",
            "Engage with the audience",
            "Focus on the content",
        ),
        (
            "In casual conversations, do you:",
            "Initiate discussions with strangers",
        ...
        questions.append(
            {
                ...
                "question_text": q_text,
                "dimension": "S-N",
                "options": [{"text": opt1, "value": "S"}, {"text": opt2, "value": "N"}],
            }
        )
        question_id += 1
        ...
        questions.append(
            {
                ...
                "question_text": q_text,
                "dimension": "T-F",
                "options": [{"text": opt1, "value": "T"}, {"text": opt2, "value": "F"}],
            }
        )
        question_id += 1
        ...
        questions.append(
            {
                ...
                "question_text": q_text,
                "dimension": "J-P",
                "options": [{"text": opt1, "value": "J"}, {"text": opt2, "value": "P"}],
            }
        )
        question_id += 1
...
def main():
    ...
    with open(
        "/Users/sheriftito/Downloads/psychsync/big_five_90_questions.json", "w"
    ) as f:
    ...
    return {"mbti": mbti_questions, "big_five": big_five_questions}
