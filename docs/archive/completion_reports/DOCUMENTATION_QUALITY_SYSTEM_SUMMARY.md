...
**Files:**
- `test_app.ai.agents_examples.py` (22KB) - Pytest test suite
...
# Run with pytest
pytest tests/documentation/test_app.ai.agents_examples.py -v

# Run specific test
pytest tests/documentation/test_app.ai.agents_examples.py::test_json_examples_valid -v
```
...
└── tests/
    └── documentation/
        ...
        ├── test_app.ai.agents_examples.py              ← 22KB pytest suite
...
**Want to extend?**
- Add new tests: Edit `tests/documentation/test_app.ai.agents_examples.py`
