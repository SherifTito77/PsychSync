...
0 2 * * * cd /path/to/psychsync && python app.ai.agents/run_agents.py --category security --output security_report.json

# Weekly performance analysis on Sunday at 3 AM
0 3 * * 0 cd /path/to/psychsync && python app.ai.agents/run_agents.py --category performance --output perf_report.json
```
...
1. **`app.ai.agents/__init__.py`** - Package exports for all 54 agents
2. **`app.ai.agents/agent_framework.py`** - Core framework (356 lines)
3. **`app.ai.agents/code_quality_agents.py`** - 13 code quality agents (549 lines)
4. **`app.ai.agents/testing_performance_agents.py`** - 17 testing/performance agents (829 lines)
5. **`app.ai.agents/analytics_workflow_agents.py`** - 24 analytics/workflow agents (1,035 lines)
6. **`app.ai.agents/run_agents.py`** - CLI orchestrator script (431 lines)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('app.ai.agents/agent_execution.log'),
...
2. Check execution logs: `app.ai.agents/agent_execution.log`
3. Run `python app.ai.agents/run_agents.py --help`
