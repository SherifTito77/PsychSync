...
```bash
$ python app.ai.agents/run_agents.py --agent uptime_monitor
...
```python
from app.ai.agents import TOTAL_AGENTS
...
python app.ai.agents/run_agents.py --agent security_header_validator

# Check encryption for sensitive data
python app.ai.agents/run_agents.py --agent encryption_strategy

# Detect unsafe third-party scripts
python app.ai.agents/run_agents.py --agent third_party_script_safety
```
...
python app.ai.agents/run_agents.py --agent performance_regression

# Track slow endpoints
python app.ai.agents/run_agents.py --agent slow_endpoint_tracker
...
python app.ai.agents/run_agents.py --agent coding_style_enforcer

# Detect localization gaps
python app.ai.agents/run_agents.py --agent localization_gap_detector

# Propose refactoring targets
python app.ai.agents/run_agents.py --agent refactoring_target_proposer
```
...
python app.ai.agents/run_agents.py --agent incident_mitigation_planner

# Generate weekly stability score
python app.ai.agents/run_agents.py --agent weekly_stability_scorer
```
...
# Security checks
python app.ai.agents/run_agents.py --agent security_header_validator
python app.ai.agents/run_agents.py --agent permission_gap_detector

# Performance checks
python app.ai.agents/run_agents.py --agent performance_regression
python app.ai.agents/run_agents.py --agent environment_config_detector
```
...
python app.ai.agents/run_agents.py --agent architecture_drift_detector

# Check test coverage
python app.ai.agents/run_agents.py --agent test_coverage_reporter
```
...
# Review UX issues
python app.ai.agents/run_agents.py --agent ux_friction_tracker
```
