...
Run with: python3 test_app.ai.agents.py
"""
...
try:
    from app.services.app.ai.agents.development_agents import (
        coding_style_agent,
        localization_agent,
    ...
    from app.services.app.ai.agents.encryption_strategy_agent import encryption_strategy_agent
    from app.services.app.ai.agents.operations_agents import (
    ...
    from app.services.app.ai.agents.security_headers_agent import security_headers_agent
    from app.services.app.ai.agents.unsafe_script_agent import unsafe_script_agent
...
try:
    from app.api.v1.endpoints import app.ai.agents
    router = app.ai.agents.router
