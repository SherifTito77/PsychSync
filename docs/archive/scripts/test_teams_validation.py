...
def test_team_crud():
    ...
    try:
        response = requests.post(
            f"{API_URL}/api/v1/teams/", headers=get_headers(), json=team_data
        )
...
def test_team_list():
    ...
    try:
        response = requests.get(f"{API_URL}/api/v1/teams/", headers=get_headers())
...
def test_team_update(team_id):
    ...
    try:
        response = requests.put(
            f"{API_URL}/api/v1/teams/{team_id}", headers=get_headers(), json=update_data
        )
...
def test_team_delete(team_id):
    ...
    try:
        response = requests.delete(
            f"{API_URL}/api/v1/teams/{team_id}", headers=get_headers()
        )
