...
async def verify_imports():
    ...
    try:
        ...
        # Test core scorers
        from ai.clinical.scoring_algorithms import CSSRSScorer, GAD7Scorer, PHQ9Scorer
...
async def verify_scorers():
    ...
    from ai.clinical.scoring_algorithms import GAD7Scorer, PHQ9Scorer
    from app.services.clinical.additional_scorers import (
        ACEScorer,
        AQ10Scorer,
        DAST10Scorer,
...
async def verify_documentation():
    ...
    docs = [
        ...
        "ai.clinical.scoring_algorithms.py",
