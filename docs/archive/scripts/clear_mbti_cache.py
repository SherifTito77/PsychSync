    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get("success"):
                ...
                print(
                    f"🎯 Dimensions Covered: {len(set(q.get('dimension') for q in questions))}"
                )
                ...
                for i, q in enumerate(questions[:3], 1):
                    ...
                    for opt in options:
                        print(
                            f"      • {opt.get('text', 'N/A')} ({opt.get('value', 'N/A')})"
                        )
                    print()
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            indicators = {
                ...
                "Error State": "error" in content.lower()
                or "something went wrong" in content.lower(),
