...
def generate_function_docstring(
    function_name: str, function_type: str, context: str = ""
) -> str:
...
"""
        ...
        "update" in function_name or "patch" in function_type or "put" in function_type
    ):
...
"""
        ...
        "delete" in function_name
        or "remove" in function_name
        or "delete" in function_type
    ):
...
"""
        ...
        or "Response" in class_name
        or "Create" in class_name
        or "Update" in class_name
    ):
