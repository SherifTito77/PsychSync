...
class PsychSyncAPIValidator:
    ...
    def test_health_endpoint(self):
        ...
        try:
            ...
            self.log_result("Health Check", "ERROR", str(e), time.time() - start_time)
            return False
    ...
    def test_api_docs(self):
        ...
        for endpoint, name in endpoints:
            ...
            try:
                ...
                self.log_result(
                    f"API Docs - {name}", "ERROR", str(e), time.time() - start_time
                )
                all_passed = False
    ...
    def test_authentication(self):
        ...
        try:
            ...
            # Test login
            start_time = time.time()
            login_data = {"username": test_email, "password": "SecureTest123!"}
            ...
            if response.status_code == 200:
                ...
                self.log_result(
                    "User Login", "PASS", "Token received successfully", response_time
                )
                return True
            else:
                self.log_result(
                    "User Login", "FAIL", f"HTTP {response.status_code}", response_time
                )
                return False

        except Exception as e:
            self.log_result(
                "Authentication Flow", "ERROR", str(e), time.time() - start_time
            )
            return False
    ...
    def test_protected_endpoints(self):
        ...
        if not self.auth_token:
            self.log_result(
                "Protected Endpoints", "SKIP", "No authentication token available"
            )
            return False
        ...
        for endpoint, name in protected_endpoints:
            ...
            try:
                ...
                self.log_result(
                    f"Protected - {name}", "ERROR", str(e), time.time() - start_time
                )
                all_passed = False
    ...
    def test_public_endpoints(self):
        ...
        public_endpoints = [("/api/v1/health", "Health Check"), ("/", "API Root")]
        ...
        for endpoint, name in public_endpoints:
            ...
            try:
                ...
                self.log_result(
                    f"Public - {name}", "ERROR", str(e), time.time() - start_time
                )
                all_passed = False
    ...
    def test_error_handling(self):
        ...
        try:
            ...
            if response.status_code == 404:
                self.log_result(
                    "404 Error Handling", "PASS", "Proper 404 response", response_time
                )
            else:
                self.log_result(
                    "404 Error Handling",
            ...
            self.log_result(
                "404 Error Handling", "ERROR", str(e), time.time() - start_time
            )
            return False
        ...
        try:
            ...
            if response.status_code == 401:
                self.log_result(
                    "Unauthorized Access", "PASS", "Proper 401 response", response_time
                )
            else:
                self.log_result(
                    "Unauthorized Access",
            ...
            self.log_result(
                "Unauthorized Access", "ERROR", str(e), time.time() - start_time
            )
            return False
