...
def generate_additional_enneagram_questions():
    ...
    type1_additional = [
        ...
        (
            "In leadership roles, I:",
            "Set high standards for everyone",
            "Encourage others' authentic development",
        ),
        (
            "My inner critic is loudest when:",
            "I or others make mistakes",
            "I feel I'm not living up to potential",
        ),
        (
            "I find it hardest to:",
            "Forgive my own imperfections",
            "Accept others' flaws",
        ),
        (
        ...
        (
            ...
            "My integrity and high standards",
            "My ability to see what's right",
        ),
        (
            "I relax best when:",
    ...
    type2_additional = [
        ...
        (
            ...
            "Mediate and seek harmony",
            "State my own needs clearly",
        ),
        ("My greatest fear is:", "Being unloved or unwanted", "Being abandoned"),
        (
            "I struggle with:",
            "Feeling worthy without helping",
            "Setting appropriate limits",
        ),
        (
            "Others see me as:",
            "Overly involved in their problems",
    ...
    type3_additional = [
        (
            ...
            "External achievements and recognition",
            "Inner fulfillment and growth",
        ),
        (
            "My biggest fear is:",
        ...
        (
            "I struggle with:",
            "Separating my worth from my success",
        ...
        (
            "In relationships, I:",
            "Project success and confidence",
            "Show my authentic self",
        ),
        (
            "I feel most anxious when:",
            "I'm not achieving or progressing",
            "Others might see my flaws",
        ),
        ...
        (
            ...
            "Truly successful and fulfilled",
        ),
    ]
    ...
    type4_additional = [
        (
            ...
            "Others don't see my depth",
            "I seem too dramatic",
        ),
        (
            "My greatest struggle is:",
            "Feeling ordinary or mundane",
            "Managing my emotional intensity",
        ),
        (
            "People would describe me as:",
        ...
        (
            "Others criticize me for being:",
            "Too moody or self-absorbed",
            "Overly dramatic",
        ),
        (
            "At my best, I am:",
            "Creatively inspired and authentic",
    ...
    type5_additional = [
        ...
        (
            "My biggest challenge is:",
            "Engaging with the emotional world",
            "Sharing my inner thoughts",
        ),
        (
            "People see me as:",
            "Detached or overly analytical",
    ...
    type6_additional = [
        (
            ...
            "Trust in supportive relationships",
        ),
        (
            "My biggest challenge is:",
            "Trusting myself and others",
            "Making decisions without doubt",
        ),
        (
            "People would describe me as:",
            "Anxious or overly cautious",
            "Loyal and committed",
        ),
        (
            "I feel most anxious when:",
            "I don't have a safety net",
            "I have to act independently",
        ),
        (
