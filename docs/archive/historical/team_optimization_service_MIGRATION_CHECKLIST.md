...
Migration Checklist for Team_Optimization_Service
================================================================================

ANALYSIS RESULTS:
================================================================================

Service Name: team_optimization_service
File: app/services/team_optimization_service.py
Classes Found: 1
Functions Found: 0
Async Methods: 0

IMPORTS:
  - typing\n  - sqlalchemy\n  - sqlalchemy.ext.asyncio\n  - app.db.models.team\n  - app.db.models.user\n  - app.services.optimizer.team_optimizer\n  - app.services.scoring_service
...
Phase 2: Create Template (15 minutes)
  [ ] Run: python scripts/generate_migration_template.py team_optimization_service
