...
```bash
PORT=8001 python3 app.ai.agents_service.py
```
...
### Example
```bash
PORT=8001 HOST=127.0.0.1 python3 app.ai.agents_service.py
```
...
ExecStart=/usr/bin/python3 /opt/psychsync/app.ai.agents_service.py
Restart=always
...
```ini
[program:ai-agents]
command=/usr/bin/python3 /opt/psychsync/app.ai.agents_service.py
...
- Run demo: `python3 test_app.ai.agents.py`
