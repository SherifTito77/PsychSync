...
| Backend Development | 60% | 100% | 🟢 Ahead |
...
| **Backend Lead** | Alex Johnson | Active | 40h/week |
...
- Great collaboration between data science and backend teams
...
- [ ] Schedule daily sync between frontend/backend
