...
ENDPOINT_EXAMPLES = {
    ...
    "GET /api/v1/users/": {
        "parameters": {
            "skip": {"description": "Number of records to skip (pagination)", "example": 0, "schema": {"type": "integer"}},
            "limit": {"description": "Maximum number of records to return", "example": 10, "schema": {"type": "integer"}},
            "search": {"description": "Search term to filter users", "example": "john", "schema": {"type": "string"}},
            "role": {"description": "Filter by user role", "example": "user", "schema": {"type": "string", "enum": ["user", "admin", "manager"]}}
        },
        "responses": {
            200: {
                "items": [
    ...
    "GET /api/v1/assessments/": {
        "parameters": {
            ...
            "framework": {"description": "Filter by assessment framework", "example": "big_five"},
    ...
    "GET /api/v1/analytics/dashboard": {
        "parameters": {
            "period": {"description": "Time period for analytics", "example": "30d", "enum": ["7d", "30d", "90d", "1y"]},
            "organization_id": {"description": "Filter by organization", "example": 1}
        },
        "responses": {
            200: {
...
def main():
    ...
    print(f"📊 Total critical endpoints: {sum(len(endpoints) for endpoints in CRITICAL_ENDPOINTS.values())}")
