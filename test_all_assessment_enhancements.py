...
def main():
    ...
    assessments = [
        ...
        },
        {
            ...
            'theme': 'purple',
            'checks': [
                ("Enneagram framework education", "Understanding Your Enneagram Results"),
                ("Nine types overview", "The Nine Enneagram Types"),
                ("Three intelligence centers", "The Three Intelligence Centers"),
                ("Type-specific deep dive", "Your Enneagram Type {results.enneagram_type} Deep Dive"),
        ...
        },
        {
            ...
            'theme': 'blue',
            'checks': [
                ("PI framework education", "Understanding Your Predictive Index Results"),
        ...
        },
        {
            ...
            'theme': 'blue',
            'checks': [
                ("Social Styles framework education", "Understanding Your Social Style Results"),
                ...
                ("Style-specific deep dive", "Your {results.social_style_type} Style Deep Dive"),
        ...
        },
        {
            ...
            'theme': 'green',
            'checks': [
                ("StrengthsFinder education", "Understanding Your StrengthsFinder Results"),
                ...
                ("Strength development strategies", "Living and Leading with Your Strengths"),
    ...
    for assessment in assessments:
        ...
        assessment_percentage = (assessment_passed / assessment_total) * 100 if assessment_total > 0 else 0
        print(f"  📈 {assessment['name']}: {assessment_passed}/{assessment_total} ({assessment_percentage:.1f}%)")
    ...
    for result in assessment_results:
        status_emoji = "✅" if result['percentage'] >= 90 else "⚠️" if result['percentage'] >= 70 else "❌"
        print(f"{status_emoji} {result['name']}: {result['passed']}/{result['total']} ({result['percentage']:.1f}%) - {result['status']}")
    ...
    if total_passed >= total_checks * 0.95:  # 95% success rate
        ...
        print(f"   📚 Educational Content: All assessments include framework explanations")
        print(f"   🎯 Personalized Insights: Dynamic content based on user results")
        print(f"   💼 Practical Applications: Workplace, career, and relationship guidance")
        ...
        print(f"   From: Basic score displays → To: Comprehensive personality education")
        ...
        if needs_enhancement:
            ...
            for result in needs_enhancement:
                print(f"   • {result['name']}: Only {result['percentage']:.1f}% complete")
