...
backend_files = [
    ...
    # API Endpoints
    ("app/api/v1/endpoints/screening.py", "Screening endpoints with LSAS/EAT-26/Y-BOCS"),
...
frontend_files = [
    ...
    # Telehealth
    ("frontend/src/components/telehealth/VideoConsultation.tsx", "Video Consultation UI"),
    ("frontend/src/components/telehealth/TelehealthScheduler.tsx", "Telehealth Scheduler UI"),
    ("frontend/src/components/telehealth/index.ts", "Telehealth components index"),

    # Analytics
    ("frontend/src/components/analytics/ClinicalAnalyticsDashboard.tsx", "Analytics Dashboard UI"),
...
try:
    ...
    methods = ["create_consultation_room", "join_session", "start_session", "end_session"]
