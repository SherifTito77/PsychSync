...
def generate_mbti_questions():
    ...
    e_i_questions = [
        ...
        for q, opt1, opt2 in [
            ...
            ("In your free time, do you prefer:", "Social activities and events", "Quiet hobbies and personal projects"),
    ...
    t_f_questions = [
        ...
        ("Do you value truth more when it's:", "Objective and verifiable", "Emotionally resonant"),
...
def generate_enneagram_questions():
    ...
    type_questions = {
        "type1": [
            ("I feel driven to:", "Be perfect and do things right", "Accept imperfection in myself and others"),
            ("My biggest struggle is:", "My inner critic and anger", "Accepting that good enough is often sufficient"),
            ("People see me as:", "Overly critical and demanding", "Having high standards and integrity"),
            ("I react to mistakes by:", "Feeling frustrated and wanting to fix them", "Learning from them and moving on"),
            ("In relationships, I need:", "Clear expectations and mutual improvement", "Acceptance and appreciation"),
            ("My core motivation is:", "To be good and worthy", "To be happy and content"),
            ("I struggle with:", "Repression of my anger and desires", "Expressing my true feelings"),
            ("I admire people who are:", " principled and ethical", "Spontaneous and free-spirited"),
            ("My biggest fear is:", "Being corrupt or evil", "Being ordinary or mediocre"),
            ("I find peace when:", "Everything is in its proper place", "I can let go of control")
        ],
        "type2": [
            ("I express love by:", "Being helpful and supportive", "Setting healthy boundaries"),
            ("My greatest strength is:", "My ability to understand others", "My ability to care for myself"),
            ("People often take advantage of my:", "Generosity and kindness", "Desire to be needed"),
            ("I struggle with:", "Acknowledging my own needs", "Asking for help when I need it"),
            ("In relationships, I:", "Give more than I receive", "Maintain healthy give-and-take"),
            ("My core motivation is:", "To be loved and needed", "To be self-sufficient"),
            ("I fear being:", "Unwanted or unloved", "Alone and independent"),
            ("I admire people who are:", "Compassionate and giving", "Self-contained and autonomous"),
            ("My biggest challenge is:", "Recognizing my own value", "Setting appropriate limits"),
            ("I feel best when:", "Others appreciate my help", "I can care for myself properly")
        ]
