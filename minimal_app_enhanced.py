...
class EnhancedAIProcessor:
    ...
    def _load_personality_data(self) -> Dict[str, Dict]:
        return {
            ...
            "enneagram": {
                "Type 1": {
                    "title": "The Reformer",
                    "description": "Rational and idealistic with strong principles.",
                },
                "Type 2": {
                    "title": "The Helper",
                    "description": "Caring and interpersonal with generous spirit.",
                },
                "Type 3": {
                    "title": "The Achiever",
                    "description": "Success-oriented and pragmatic with image-conscious drive.",
                },
            },
            "big_five": {
                "High Openness": {
                    "title": "Openness",
                    "description": "Open to experience, creative, curious and imaginative.",
                },
                "High Conscientiousness": {
                    "title": "Conscientiousness",
                    "description": "Organized, disciplined, achievement-oriented.",
                },
            },
        }
        ...
        return {
            "leadership_potential": {
                ...
                "ENFP": {
                    ...
                    "strengths": ["Motivation", "Creativity"],
                },
                "ISTJ": {
                    "score": 0.82,
                    "style": "Procedural/Administrative",
                    "strengths": ["Organization", "Reliability"],
                },
                "ESFJ": {
                    "score": 0.75,
                    "style": "Supportive/Democratic",
                    "strengths": ["Team building", "Harmony"],
                },
            },
            "communication_style": {
                "INTJ": {
    ...
    def process_with_enhanced_ai(self, request: AIRequest) -> Dict[str, Any]:
        ...
        if cache_key in ai_cache:
            ...
            if datetime.now() - cached_result["cached_at"] < timedelta(
        ...
        try:
            ...
            # Cache the result
            ai_cache[cache_key] = {"data": result, "cached_at": datetime.now()}
    ...
    def _generate_cache_key(self, framework: str, data: Dict[str, Any]) -> str:
        ...
        cache_data = (
            f"{framework}:{data.get('type', 'unknown')}:{data.get('confidence', 0)}"
        )
    ...
    def _generate_enhanced_response(self, request: AIRequest) -> Dict[str, Any]:
        ...
        personality_data = framework_data.get(
            personality_type,
            {
        ...
        workplace_insights = self.workplace_insights["leadership_potential"].get(
            personality_type, {}
        )
        communication_style = self.workplace_insights["communication_style"].get(
            personality_type, {}
        )
        ...
        enhanced_result = {
            ...
            "detailed_analysis": {
                ...
                "motivational_drivers": self._get_motivational_drivers(
                    personality_type
                ),
                "potential_challenges": self._get_potential_challenges(
                    personality_type
                ),
            ...
            "growth_trajectory": {
                ...
                "skill_development_priorities": self._get_skill_priorities(
                    personality_type
                ),
            },
    ...
    def _generate_detailed_analysis(self, personality_type: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "problem_solving_approach": self._get_problem_solving_style(
                personality_type
            ),
    ...
    def _analyze_team_dynamics(self, personality_type: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "collaboration_preferences": self._get_collaboration_style(
                personality_type
            ),
            "team_building_contributions": self._get_team_contributions(
                personality_type
            ),
    ...
    def _generate_personalized_recommendations(
        self, personality_type: str, user_context: Dict, framework: str
    ) -> List[str]:
    ...
    def _get_potential_challenges(self, personality_type: str) -> List[str]:
        challenges = {
            ...
            "ESFJ": [
                ...
                "Over-commitment to others",
                "Neglecting self-care",
            ],
        }
        return challenges.get(
            personality_type,
            ["General adaptation challenges", "Communication barriers"],
        )
    ...
    def _generate_fallback_response(self, request: AIRequest) -> Dict[str, Any]:
        ...
        return {
            ...
            "basic_insights": [
                "AI processing encountered issues, showing basic analysis"
            ],
        }
...
async def health_check():
    ...
    try:
        ...
        # Test AI engine
        ai_test = ai_processor.process_with_enhanced_ai(
            AIRequest(framework="mbti", data={"type": "INTJ", "confidence": 0.9})
        )
        ...
        return {
            ...
            "performance_metrics": {
                ...
                "response_time_ms": round(
                    performance_metrics["avg_response_time"] * 1000, 2
                ),
            },
        }
...
async def get_personalized_insights_enhanced(request: dict):
    ...
    return {
        ...
        "leadership_potential": enhanced_result.get("workplace_compatibility", {}).get(
            "leadership_potential", {}
        ),
        "communication_guidance": enhanced_result.get(
            "workplace_compatibility", {}
    ...
    try:
            ...
            if "personality_type" in member:
                ai_request = AIRequest(
                    ...
                    data={
                        ...
                        "confidence": member.get("confidence", 0.8),
                    },
        ...
        team_analysis = {
            ...
            "optimal_team_size": (
                ...
                else "Consider splitting into smaller teams"
            ),
...
async def get_performance_metrics():
    ...
    return {
        ...
        "cache_hit_rate": round(
            ...
            / max(1, performance_metrics["requests_processed"])
            * 100,
            2,
        ),
        "errors_handled": performance_metrics["errors_handled"],
        "error_rate": round(
            performance_metrics["errors_handled"]
            / max(1, performance_metrics["requests_processed"])
            * 100,
            2,
        ),
        ...
        "system_status": (
            "operational" if performance_metrics["error_rate"] < 5 else "degraded"
        ),
    }
...
def _analyze_leadership_distribution(member_analyses: List[Dict]) -> Dict[str, Any]:
    ...
    for analysis in member_analyses:
        leadership_potential = (
            analysis["analysis"]
            .get("workplace_compatibility", {})
            .get("leadership_potential", {})
        )
        leadership_scores.append(leadership_potential.get("score", 0.5))

    avg_leadership = (
        sum(leadership_scores) / len(leadership_scores) if leadership_scores else 0
    )
    ...
    return {
        ...
        "leadership_distribution": (
            "Balanced" if 0.6 <= avg_leadership <= 0.8 else "Needs attention"
        ),
    }
...
def _calculate_team_health_score(member_analyses: List[Dict]) -> float:
    ...
    leadership = _analyze_leadership_distribution(member_analyses)[
...
def _analyze_decision_making(personality_type: str) -> Dict[str, str]:
    return {"approach": "Analytical", "speed": "Moderate", "confidence": "High"}
