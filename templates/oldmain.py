...
# from app.middleware.auth_middleware import TokenDecodeMiddleware   # optional if you add middleware
# #from app.core.redis import set_key, get_key
# from app.core.cache import set_key, get_key
# from app.core.auth import create_access_token, verify_password
# # from app.db.session import get_db, init_db
# from fastapi.openapi.utils import get_openapi
# # app/main.py or any route file
...
# from app.api.api_router import api_router   # example path

# from app.middleware.token_decode import TokenDecodeMiddleware  # your custom middleware

# app = FastAPI(title="PsychSync SaaS")
...
# # app.include_router(users.router, api_router, prefix="/users", tags=["users"])
...
# @app.get("/")
# def read_root():
#     return {"message": "FastAPI SaaS is running!"}
...
# # ✅ Register middleware
# # optional request-level token decode
# # app.add_middleware(TokenDecodeMiddleware)

# # Include API router
# app.include_router(api_router, prefix="/api/v1")
# app.add_middleware(TokenDecodeMiddleware)  # optional
# app.include_router(api_router)
...
#         routes=app.routes,
#     )
#     # Add OAuth2 password flow so docs show "Authorize"
...
#         }
#     }
#     # Add global security if desired (comment out to require per-route)
