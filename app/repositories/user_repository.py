...
class UserRepository(BaseRepository[User, UserCreate, UserUpdate]):
    ...
    async def get_users_by_role(
        self, role: str, include_inactive: bool = False, skip: int = 0, limit: int = 100
    ) -> tuple[list[User], int]:
        """
        Get users by role
    ...
    async def search_users(
        self, search_term: str, organization_id: Any | None = None, limit: int = 20
    ) -> list[User]:
        """
    ...
    async def get_unverified_users(
        ...
        try:
            ...
            user_repo_logger.debug(
                ...
                extra={"days_old": days_old, "results_count": len(users)},
            )
    ...
    async def get_user_statistics(
        ...
        try:
            ...
            user_repo_logger.info(
                ...
                extra={"organization_id": organization_id, "statistics": statistics},
            )
    ...
    async def update_last_login(
        self, user_id: Any, client_ip: str | None = None, user_agent: str | None = None
    ) -> bool:
        """
    ...
    async def deactivate_user(
        self, user_id: Any, reason: str | None = None, deactivated_by: Any | None = None
    ) -> bool:
        """
    ...
    async def get_user_with_organization(self, user_id: Any) -> User | None:
        """
