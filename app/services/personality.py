...
class PersonalityMapper:
    ...
    def map_traits(
        ...
        try:
            ...
            logger.error(f"Error mapping traits from framework {framework}: {e!s}")
    ...
    def calculate_compatibility(
        ...
        try:
            ...
            logger.error(f"Error calculating compatibility: {e!s}")
            return 0.5

    def get_compatibility_insights(
        self, traits_a: dict[str, float], traits_b: dict[str, float]
    ) -> list[str]:
        ...
        for dim, label in big_five_labels.items():
            ...
            if dim == "neuroticism":
                if a_val < 0.3 and b_val < 0.3:
                    ...
                    insights.append("One or both may experience emotional challenges")
            elif diff < 0.2:
