...
class PlayerScoringEngine:
    ...
    def calculate_score(
        ...
        position: str,
        league_data: list[PlayerMetrics] | None = None,
    ) -> ScoringResult:
        """
    ...
    def _calculate_percentiles(
        self, player: PlayerMetrics, league_data: list[PlayerMetrics]
    ) -> dict[str, float]:
...
class ScoringAPIService:
    ...
    def score_player(self, player_id: str, timeframe: str = "current") -> dict:
        """
