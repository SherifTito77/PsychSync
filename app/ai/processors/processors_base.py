...
class PersonalityFrameworkProcessor(ABC):
    ...
    def _ensure_confidence(
        self, data: Dict[str, Any], default: float = 0.8
    ) -> Dict[str, Any]:
    ...
    def get_framework_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            or f"{self.framework_name.title()} personality framework processor",
            "supported_dimensions": (
                list(self._default_dimensions().keys())
                if hasattr(self, "_default_dimensions")
                else []
            ),
        }
