...
async def get_incident(
    ...
    try:
        ...
        incident = await safety_service.get_incident(incident_id, current_user.id)
...
async def update_incident(
    ...
    try:
        ...
        result = await safety_service.update_incident_status(
...
async def create_safety_resource(
    ...
    try:
        ...
        result = await safety_service.create_safety_resource(
            organization_id=current_user.organization_id,
...
async def get_safety_resources(
    ...
    try:
        ...
        resources = await safety_service.get_safety_resources(
            organization_id=current_user.organization_id,
