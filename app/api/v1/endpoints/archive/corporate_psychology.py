...
async def get_psychology_metrics(
    ...
    try:
        ...
        query = (
            ...
            .where(CorporatePsychologyMetrics.organization_id == organization_id)
        ...
        if not metrics:
            raise HTTPException(
                status_code=404,
                detail="No psychology metrics found. Run analysis first.",
            )
...
async def get_system_signals(
    ...
    try:
        query = (
            ...
            .where(SystemSignalAlert.organization_id == organization_id)
...
async def get_interventions(
    ...
    try:
        query = (
            ...
            .where(StructuralIntervention.organization_id == organization_id)
