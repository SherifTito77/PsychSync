...
async def get_backup_statistics(current_user: User = Depends(get_current_admin_user)):
    """
...
async def get_backup_config(current_user: User = Depends(get_current_admin_user)):
    """
...
async def test_storage_connection(current_user: User = Depends(get_current_admin_user)):
    """
