...
async def predict_dropout_risk(request: PredictDropoutRequest):
    ...
    **Example:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error predicting dropout risk: {e!s}",
        ) from e
...
async def predict_trajectory(request: ClientFeaturesRequest):
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error predicting trajectory: {e!s}",
        ) from e
...
async def detect_patterns(request: PatternDetectionRequest):
    ...
    **Returns:**
    ...
    try:
        ...
        df = pd.DataFrame(
            [{"date": item.date, "score": item.score} for item in request.time_series]
        )
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error detecting patterns: {e!s}",
        ) from e
...
async def detect_anomaly(request: AnomalyDetectionRequest):
    ...
    **Use cases:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error detecting anomaly: {e!s}",
        ) from e
...
async def analyze_trajectory(request: TrajectoryAnalysisRequest):
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error analyzing trajectory: {e!s}",
        ) from e
...
async def analyze_intervention(request: InterventionAnalysisRequest):
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error analyzing intervention: {e!s}",
        ) from e
