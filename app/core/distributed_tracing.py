...
class DistributedTracer:
    ...
    def finish_span(
        ...
        error_message: Optional[str] = None,
        error_type: Optional[str] = None,
        final_tags: Optional[Dict[str, Any]] = None
    ):
        """Finish a span"""
    ...
    def get_span_data(self, span_id: str) -> Optional[SpanAttributes]:
        """Get span data"""
        return self.span_storage.get(span_id)

    def get_trace_data(self, trace_id: str) -> List[SpanAttributes]:
        """Get all spans for a trace"""
        return [span for span in self.span_storage.values()
        ...
        async with self.tracer.start_span(
            ...
            try:
                ...
                if hasattr(self.tracer, 'add_span_metric'):
                    ...
                    self.tracer.add_span_metric(span_id, "response_size_bytes",
                ...
                self.tracer.add_span_event(span_id, "exception", {
