    ...
    def verify_certificates(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if oct(cert_stat.st_mode)[-3:] in ['640', '600']:
                ...
                results["issues"].append(f"Certificate file permissions too open: {oct(cert_stat.st_mode)[-3:]}")
            ...
            if oct(key_stat.st_mode)[-3:] == '600':
                ...
                results["issues"].append(f"Private key file permissions too open: {oct(key_stat.st_mode)[-3:]}")
