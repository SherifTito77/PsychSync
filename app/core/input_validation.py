...
class InputValidator:
    ...
    @classmethod
    def validate_uuid(cls, value: Union[str, uuid.UUID], field_name: str = "ID") -> str:
    ...
    @classmethod
    def validate_safe_string(cls, value: str, field_name: str = "Input",
    ...
    @classmethod
    def validate_pagination_params(cls, skip: int = 0, limit: int = 100,
    ...
    @classmethod
    def validate_file_upload(cls, filename: str, allowed_extensions: List[str] = None,
...
def validate_uuid_field(value: Union[str, uuid.UUID]) -> str:
