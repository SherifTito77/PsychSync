...
class SecretManager:
    ...
    def _get_encryption_key(self) -> bytes:
        ...
        if self._encryption_key is None:
            ...
            key_source = os.getenv('SECRET_ENCRYPTION_KEY') or os.getenv('SECRET_KEY', 'default-key')
    ...
    def get_secret(self, secret_name: str, required: bool = True, default: Optional[str] = None) -> Optional[str]:
        """
    ...
    def _validate_secret_strength(self, secret_name: str, secret_value: str) -> None:
        ...
        if secret_name.endswith('_KEY') or secret_name.endswith('_SECRET'):
            ...
            weak_patterns = [
                'changeme', 'default', 'example', 'test', 'demo',
...
def get_secure_secret(secret_name: str, required: bool = True) -> Optional[str]:
