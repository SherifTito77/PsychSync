    ...
    try:
        ...
        for org_id, feedbacks in org_overdue.items():
            try:
                ...
                email_subject = "⚠️ ESCALATION: Overdue Anonymous Feedback Review"
...
async def generate_monthly_anonymous_feedback_report(
    ...
    try:
        ...
        stats = await anonymous_feedback_service.get_anonymous_feedback_statistics(
            db=db, organization_id=organization_id, days_back=30
        )
        ...
        report_data = {
            ...
            "psychological_safety_level": stats.get("insights", {}).get(
                "psychological_safety_level", "unknown"
            ),
