...
def test_encryption_service():
    ...
    try:
        ...
        decrypted = service.decrypt_pii(encrypted.encrypted_data, key_id=encrypted.key_id)
        ...
        decrypted_complex = service.decrypt_pii(
            encrypted_complex.encrypted_data,
            key_id=encrypted_complex.key_id
        )

        print(f"   Decrypted: {decrypted_complex}")
        assert decrypted_complex == complex_data, "Decrypted complex data doesn't match!"
        ...
        decrypted_phi = service.decrypt_pii(
            encrypted_phi.encrypted_data,
            key_id=encrypted_phi.key_id
        )
