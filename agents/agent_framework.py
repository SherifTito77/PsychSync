...
class AgentOrchestrator:
    ...
    def execute_agent(
        self, agent_name: str, context: Dict[str, Any] = None
    ) -> AgentResult:
    ...
    def execute_all(
        self, category: Optional[str] = None, context: Dict[str, Any] = None
...
def find_files(
    project_root: Path, pattern: str, exclude_patterns: List[str] = None
) -> List[Path]:
