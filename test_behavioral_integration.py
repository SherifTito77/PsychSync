...
class BehavioralIntegrationTester:
    ...
    async def test_api_connectivity(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"   ✅ Services: {data.get('dependency_injection', {}).get('services_count', 0)}")
        ...
        try:
            ...
            if openapi_response.status_code == 200:
                ...
                for endpoint in behavioral_endpoints:
                    ...
                    if any(ep.startswith(endpoint_pattern.split("{")[0]) for ep in paths.keys()):
                        found_endpoints += 1

                print(f"   ✅ Found {found_endpoints}/{len(behavioral_endpoints)} behavioral pattern endpoints")
                ...
                print(f"   ❌ Could not fetch OpenAPI spec: {openapi_response.status_code}")
        except Exception as e:
    ...
    async def test_behavioral_analytics_api(self):
        ...
        try:
            ...
            if openapi_response.status_code == 200:
                ...
                print(f"   ✅ Found {found_analytics_endpoints}/{len(analytics_endpoints)} behavioral analytics endpoints")
    ...
    async def test_ai_integration(self):
        ...
        try:
            ...
            print(f"   ✅ Found {found_processors}/{len(ai_processor_files)} AI processor files")
    ...
    async def test_frontend_components(self):
        ...
        try:
            ...
            if found_components >= 2:
                ...
                print("   ✅ Frontend behavioral analytics components are properly set up")
            else:
    ...
    async def test_database_health(self):
        ...
        try:
            ...
            if perf_stats:
                ...
                total_transactions = perf_stats['xact_commit'] + perf_stats['xact_rollback']
    ...
    async def generate_final_report(self):
        ...
        if not self.results["api_connectivity"]:
            print("   • Start the API server: uvicorn app.main:app --host 0.0.0.0 --port 8000 --reload")
        ...
        if not self.results["ai_integration_available"]:
            print("   • Ensure AI processors and integration services are properly implemented")
        ...
        if self.results["overall_status"] == "passed":
            ...
            print("   behavioral pattern recognition, AI integration, and mental health insights.")
        else:
