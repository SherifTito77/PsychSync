...
def upgrade() -> None:
    ...
    op.create_index('idx_labor_laws_country_category', 'labor_laws', ['country_code', 'category'])
    ...
    op.create_index('idx_employee_rights_resources_org', 'employee_rights_resources', ['organization_id'])
    op.create_index('idx_employee_rights_resources_category', 'employee_rights_resources', ['category'])
    op.create_index('idx_employee_rights_resources_published', 'employee_rights_resources', ['is_published'])
    ...
    op.create_index('idx_contract_violations_org_status', 'contract_violations', ['organization_id', 'status'])
    op.create_index('idx_contract_violations_severity', 'contract_violations', ['severity'])
    op.create_index('idx_contract_violations_detected_at', 'contract_violations', ['detected_at'])
    op.create_index('idx_contract_violations_category', 'contract_violations', ['category'])
    ...
    op.create_index('idx_rights_knowledge_checks_user', 'rights_knowledge_checks', ['user_id'])
    op.create_index('idx_rights_knowledge_checks_org', 'rights_knowledge_checks', ['organization_id'])
    ...
    op.create_index('idx_legal_aid_resources_country', 'legal_aid_resources', ['country_code'])
    op.create_index('idx_legal_aid_resources_type', 'legal_aid_resources', ['resource_type'])
    op.create_index('idx_legal_aid_resources_state', 'legal_aid_resources', ['state_region'])
...
def downgrade() -> None:
    ...
    op.drop_index('idx_rights_knowledge_checks_org', table_name='rights_knowledge_checks')
    op.drop_index('idx_rights_knowledge_checks_user', table_name='rights_knowledge_checks')
    op.drop_table('rights_knowledge_checks')

    op.drop_index('idx_contract_violations_category', table_name='contract_violations')
    op.drop_index('idx_contract_violations_detected_at', table_name='contract_violations')
    op.drop_index('idx_contract_violations_severity', table_name='contract_violations')
    op.drop_index('idx_contract_violations_org_status', table_name='contract_violations')
    op.drop_table('contract_violations')

    op.drop_index('idx_employee_rights_resources_published', table_name='employee_rights_resources')
    op.drop_index('idx_employee_rights_resources_category', table_name='employee_rights_resources')
    op.drop_index('idx_employee_rights_resources_org', table_name='employee_rights_resources')
