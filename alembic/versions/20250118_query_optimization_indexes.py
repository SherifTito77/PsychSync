...
def downgrade() -> None:
    ...
    # ==================== ASSESSMENT ASSIGNMENTS ====================
    op.drop_index('idx_assessment_assignments_assessment_completed', table_name='assessment_assignments')
    op.drop_index('idx_assessment_assignments_user_completed', table_name='assessment_assignments')
