...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('data_classification', sa.String(length=20), server_default='sensitive'),
    ...
    op.create_index('idx_demographic_profiles_user', 'demographic_profiles', ['user_id'])
    op.create_index('idx_demographic_profiles_org', 'demographic_profiles', ['organization_id'])
    ...
    op.create_index('idx_equity_analyses_org_type', 'equity_analyses', ['organization_id', 'analysis_type'])
    op.create_index('idx_equity_analyses_severity', 'equity_analyses', ['severity_level'])
    ...
    op.create_index('idx_pay_equity_org_dimension', 'pay_equity_records', ['organization_id', 'demographic_dimension'])
    ...
    op.create_index('idx_hiring_metrics_org_period', 'hiring_metrics', ['organization_id', 'period_start', 'period_end'])
    op.create_index('idx_hiring_metrics_dimension', 'hiring_metrics', ['demographic_dimension'])
    ...
    op.create_index('idx_discrimination_complaints_org_status', 'discrimination_complaints', ['organization_id', 'status'])
    op.create_index('idx_discrimination_complaints_severity', 'discrimination_complaints', ['severity'])
    op.create_index('idx_discrimination_complaints_type', 'discrimination_complaints', ['complaint_type'])


def downgrade() -> None:
    # Drop tables in reverse order
    op.drop_index('idx_discrimination_complaints_type', table_name='discrimination_complaints')
    op.drop_index('idx_discrimination_complaints_severity', table_name='discrimination_complaints')
    op.drop_index('idx_discrimination_complaints_org_status', table_name='discrimination_complaints')
