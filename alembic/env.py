...
# ----------------------------------------------------------------------
# --- THIS IS THE MOST IMPORTANT SECTION TO CONFIGURE ---
# ----------------------------------------------------------------------

# Add the project root directory to the Python path.
# This allows Alembic to find and import your application's models.
...
# This tells Alembic what models to compare against the database.
