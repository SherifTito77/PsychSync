...
class AIOutputSanitizer:
    ...
    def _validate_clinical_output(self, text: str) -> List[str]:
        ...
        diagnostic_terms = [
            'diagnosis', 'disorder', 'disease', 'condition',
            'patient has', 'suffers from', 'afflicted with'
        ]
    ...
    def validate_code_output(self, code: str, language: str = "python") -> SanitizationResult:
        """
