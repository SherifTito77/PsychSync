...
async def submit_mbti_assessment(assessment_data: MBTIAssessmentRequest):
    ...
    result = {
        "type": final_type,
        "description": mbti_descriptions.get(final_type, "Your unique MBTI personality type"),
        "confidence": 0.85,
...
async def submit_enneagram_assessment(assessment_data: MBTIAssessmentRequest):
    ...
    enneagram_descriptions = {
        "Type 1": {
            ...
            "challenges": ["Critical", "Judgmental", "All-or-nothing thinking", "Resentful"],
        ...
        "Type 2": {
            ...
            "challenges": ["Possessive", "Self-sacrificing", "Manipulative", "Martyrdom"],
        ...
        "Type 3": {
            ...
            "challenges": ["Workaholic", "Inauthentic", "Competitive", "Status-seeking"],
        ...
        "Type 7": {
            ...
            "strengths": ["Optimistic", "Enthusiastic", "Adventurous", "Multi-talented"],
            "challenges": ["Impulsive", "Unfocused", "Commitment-phobic", "Superficial"],
    ...
    type_info = enneagram_descriptions.get(dominant_type, enneagram_descriptions["Type 1"])
    ...
    result = {
        ...
        "center_grouping": {
            "head_center": type_scores['Type 5'] + type_scores['Type 6'] + type_scores['Type 7'],
            "heart_center": type_scores['Type 2'] + type_scores['Type 3'] + type_scores['Type 4'],
            "gut_center": type_scores['Type 8'] + type_scores['Type 9'] + type_scores['Type 1']
        },
        "responses_count": len(responses),
        "submitted_at": time.strftime("%Y-%m-%d %H:%M:%S")
    }
                ...
                "questions": [
                    {
                        ...
                        "options": [
                            ...
                            {"text": "Support others and help where needed", "value": "D"}
                        ]
                    },
                    {
                        "id": 2,
                        ...
                        "options": [
                            {"text": "Analyze data and create logical plans", "value": "A"},
                    ...
                    },
                    {
                        ...
                        "options": [
                            {"text": "Appreciate direct, honest feedback", "value": "A"},
...
async def submit_predictive_index(assessment_data: dict):
    ...
    try:
        ...
        for question_id, answer in responses.items():
            q_id = int(question_id)
            score = 4 if answer in ['A', 'B', 'C', 'D'] else 3  # Convert response to score
        ...
        for factor in factor_scores:
            factor_scores[factor] = min(10, (factor_scores[factor] / max_possible_score) * 10)
        ...
        behavioral_patterns = {
            "High D": {
                ...
                "strengths": ["Leadership", "Decision making", "Results focus", "Risk taking"],
                "development_areas": ["Patience", "Listening to others", "Detail orientation"]
            },
            "High I": {
                ...
                "strengths": ["Communication", "Persuasion", "Optimism", "Relationship building"],
                "development_areas": ["Organization", "Attention to detail", "Follow-through"]
            },
            "High S": {
                ...
                "development_areas": ["Adaptability to change", "Assertiveness", "Quick decision making"]
            },
            "High C": {
        ...
        behavioral_pattern = behavioral_patterns.get(pattern_key, behavioral_patterns["High S"])
...
async def get_disc_questions():
    ...
    try:
            ...
            "questions": [
                {
                    ...
                    "options": [
                        ...
                        {"text": "Enthusiastically participate and persuade", "value": "I"},
        ...
        return {
            "success": False,
            "error": f"Failed to load DISC assessment: {str(e)}"
        }
...
async def get_my_responses(assessment: str = None):
    ...
    try:
        ...
        if assessment:
            filtered_results = [
                result for result in mock_results["assessments_completed"]
...
async def process_personality_assessment(request: dict):
    ...
    try:
        ...
        if framework == "mbti":
            ...
            result = {
                "type": mbti_type,
                "description": mbti_descriptions.get(mbti_type, "Your unique MBTI personality type"),
        ...
        assessment_data = {
            ...
            "questions": [
                ...
                },
                {
                    ...
                    "dimension": "Decision Making",
                    "options": [
                        {"text": "Analyze all options thoroughly", "value": "Analytical"},
                        {"text": "Make quick, decisive choices", "value": "Driver"},
                        {"text": "Consider impact on people", "value": "Amiable"},
                        {"text": "Trust my instincts and feelings", "value": "Expressive"}
                    ]
                },
                {
                    "id": 3,
                ...
                },
                {
                    ...
                    "options": [
                        {"text": "Gather more information first", "value": "Analytical"},
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        {"text": "Motivate and inspire enthusiasm", "value": "Expressive"}
                    ]
                }
            ]
        }
